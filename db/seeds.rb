...
# FruitsSmoothie.create(smoothie_id: tropical_sunrise.id, fruit_id: lemon.id, quantity: 0.5)
# FruitsSmoothie.create(smoothie_id: tropical_sunrise.id, fruit_id: pineapple.id, quantity: 0.25)
# FruitsSmoothie.create(smoothie_id: tropical_sunrise.id, fruit_id: pear.id, quantity: 1)
# FruitsSmoothie.create(smoothie_id: green_machine.id, fruit_id: broccoli.id, quantity: 2)
# FruitsSmoothie.create(smoothie_id: green_machine.id, fruit_id: kale.id, quantity: 1)
# FruitsSmoothie.create(smoothie_id: green_machine.id, fruit_id: apple.id, quantity: 1)
# FruitsSmoothie.create(smoothie_id: green_machine.id, fruit_id: kiwi.id, quantity: 2)
# FruitsSmoothie.create(smoothie_id: red_drink.id, fruit_id: apple.id, quantity: 1)
# FruitsSmoothie.create(smoothie_id: red_drink.id, fruit_id: strawberry.id, quantity: 5)
# FruitsSmoothie.create(smoothie_id: red_drink.id, fruit_id: cherry.id, quantity: 10)
# FruitsSmoothie.create(smoothie_id: red_drink.id, fruit_id: apple.id, quantity: 1)
# FruitsSmoothie.create(smoothie_id: red_drink.id, fruit_id: peach.id, quantity: 0.5)
# FruitsSmoothie.create(smoothie_id: cool_summer.id, fruit_id: watermelon.id, quantity: 0.5)
# FruitsSmoothie.create(smoothie_id: cool_summer.id, fruit_id: lemon.id, quantity: 1)
# FruitsSmoothie.create(smoothie_id: vegetable.id, fruit_id: kale.id, quantity: 1)
# FruitsSmoothie.create(smoothie_id: vegetable.id, fruit_id: broccoli.id, quantity: 3)
# FruitsSmoothie.create(smoothie_id: vegetable.id, fruit_id: cucumber.id, quantity: 1)
# FruitsSmoothie.create(smoothie_id: vegetable.id, fruit_id: tomato.id, quantity: 2)
# FruitsSmoothie.create(smoothie_id: vegetable.id, fruit_id: carrot.id, quantity: 2)
# FruitsSmoothie.create(smoothie_id: hawaiian_breeze.id, fruit_id: coconut.id, quantity: 0.25)
# FruitsSmoothie.create(smoothie_id: hawaiian_breeze.id, fruit_id: pineapple.id, quantity: 0.25)
# FruitsSmoothie.create(smoothie_id: hawaiian_breeze.id, fruit_id: mango.id, quantity: 1)
# FruitsSmoothie.create(smoothie_id: simply_strawberry.id, fruit_id: strawberry.id, quantity: 15)
# FruitsSmoothie.create(smoothie_id: simply_strawberry.id, fruit_id: grape.id, quantity: 5)
# FruitsSmoothie.create(smoothie_id: detox.id, fruit_id: orange.id, quantity: 1)
# FruitsSmoothie.create(smoothie_id: detox.id, fruit_id: lemon.id, quantity: 1)
# FruitsSmoothie.create(smoothie_id: detox.id, fruit_id: carrot.id, quantity: 2)
# FruitsSmoothie.create(smoothie_id: detox.id, fruit_id: cucumber.id, quantity: 1)
# FruitsSmoothie.create(smoothie_id: energy_boost.id, fruit_id: strawberry.id, quantity: 5)
# FruitsSmoothie.create(smoothie_id: energy_boost.id, fruit_id: coconut.id, quantity: 0.25)
# FruitsSmoothie.create(smoothie_id: energy_boost.id, fruit_id: kiwi.id, quantity: 3)
# FruitsSmoothie.create(smoothie_id: energy_boost.id, fruit_id: pineapple.id, quantity: 0.25)